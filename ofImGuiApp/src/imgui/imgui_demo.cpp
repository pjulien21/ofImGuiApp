...
// Bullet
   ...
   if (ImGui::TreeNode("Scrolling"))
      ...
      ImGui::SmallButton("<<"); if (ImGui::IsItemActive())
         {
   ...
   if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
      ...
      if (ImGui::TreeNode("Keyboard, Mouse & Navigation State"))
         ...
         ImGui::Text("NavInputs down:"); for (int i = 0; i < IM_ARRAYSIZE(io.NavInputs); i++) if (io.NavInputs[i] > 0.0f)
            {
            ImGui::SameLine(); ImGui::Text("[%d] %.2f", i, io.NavInputs[i]);
            }
         ...
         ImGui::Text("NavInputs duration:"); for (int i = 0; i < IM_ARRAYSIZE(io.NavInputs); i++) if (io.NavInputsDownDuration[i] >= 0.0f)
            {
            ImGui::SameLine(); ImGui::Text("[%d] %.2f", i, io.NavInputsDownDuration[i]);
            }
